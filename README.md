...
Document Vision Analyzer 是一款 AI 文件視覺分析工具，提供 OCR、文件描述與問答/分析等多種理解模式。適合用於自動化文件處理、表單/報表理解與知識萃取，把圖片型文件轉為可搜尋與可分析的資料。

## About (EN)

Document Vision Analyzer is an AI document understanding tool that supports OCR, visual description, and analysis-style Q&A. It helps convert image-based documents into searchable, structured, and decision-ready information.
